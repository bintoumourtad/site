...
<head>
  ...
  <title>Daaray Technologie</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="public/templates/templateVitrine/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
  ...
  <!-- =======================================================
   Template Name: Daaray Technologie
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="public/templates/templateVitrine/index.html">Daaray Technologie</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="public/templates/templateVitrine/index.html" class="logo me-auto me-lg-0"><img src="public/templates/templateVitrine/assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#apropos">Aprops</a></li>
          <li><a class="nav-link scrollto" href="#realistion">Realistion</a></li>
  ...
  <main id="main">
    ...
    <section id="apropos" class="apropos">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2"  data-aos-delay="10">
            <div class="apropos-img ">
              <img src="public/templates/templateVitrine/assets/img/apropos.jpeg"width=90%; height=30%;  alt="image-transparente">
            </div>
          </div>
    ...
    <!-- ======= realistion Section ======= -->
    <section id="realistion" class="realistion">
      <div class="container" data-aos="fade-up">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="public/templates/templateVitrine/assets/img/event-birthday.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="public/templates/templateVitrine/assets/img/event-private.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <div class="swiper-slide">
              <div class="row event-item">
                <div class="col-lg-6">
                  <img src="public/templates/templateVitrine/assets/img/event-custom.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 content">
    ...
    </section><!-- End realistion Section -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <button class="btn btn-success mt-3" name="frmAddContact" type="submit">Envoyer Message</button>
